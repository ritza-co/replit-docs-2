...
![Clicking publish from Workspace](https://replit-docs-images.util.repl.co/images/apps/workspace-publish.png)

### Publish from Spotlight
![Clicking publish from Spotlight](https://replit-docs-images.util.repl.co/images/apps/spotlight-publish.png)

### When you click on either, you'll be able to add a description, cover image, and tags to your repl.

![Filling out publish details](https://replit-docs-images.util.repl.co/images/apps/publish.gif)
...
![Clicking publish from Workspace](https://replit-docs-images.util.repl.co/images/apps/workspace-publish-update.png)

### Publish update from Spotlight
![Clicking publish from Spotlight](https://replit-docs-images.util.repl.co/images/apps/spotlight-publish-update.png)
...
![Clicking publish from Workspace](https://replit-docs-images.util.repl.co/images/apps/workspace-unpublish.png)

### Unpublishing from Spotlight
![Clicking publish from Unpublish](https://replit-docs-images.util.repl.co/images/apps/spotlight-unpublish.png)
