...
![Create project button](https://replit-docs-images.util.repl.co/images/teamsForEducation/project-create-button.png)
...
<img
  style={{ maxWidth: 600 }}
  src="https://replit-docs-images.util.repl.co/images/teamsForEducation/project-create.png"
/>
...
![Project publish button](https://replit-docs-images.util.repl.co/images/teamsForEducation/project-publish-button.png)
...
![Project submit](https://replit-docs-images.util.repl.co/images/teamsForEducation/project-submit.png)
