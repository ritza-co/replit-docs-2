...
Once your project is created, you'll find the "Input/Output Tests" window by clicking <img
  src="https://replit-docs-images.util.repl.co/images/teamsForEducation/input-output-tests/in-out-icon.png"
  style={{
    width: 38,
    margin: 0,
...
![Image showing in/out tests location](https://replit-docs-images.util.repl.co/images/teamsForEducation/input-output-tests/in-out-testing-location.png)
...
![Image showing match README.md](https://replit-docs-images.util.repl.co/images/teamsForEducation/input-output-tests/match-readme.png)

We have created some skeleton code for the student to start from.

![Image showing match main.py](https://replit-docs-images.util.repl.co/images/teamsForEducation/input-output-tests/match-skeleton-code.png)

Now we can create the test.

Open the "Input/Output Tests" pane from the left sidebar and click on "+ Create test".

![Image showing Create test button](https://replit-docs-images.util.repl.co/images/teamsForEducation/input-output-tests/create-test.png)

A modal window will pop up where you can configure the input and output of the test. 

![Image showing match test config](https://replit-docs-images.util.repl.co/images/teamsForEducation/input-output-tests/match-config.png)
...
![Image showing match test created](https://replit-docs-images.util.repl.co/images/teamsForEducation/input-output-tests/match-test-created.png)
...
![Image showing the publishing button](https://replit-docs-images.util.repl.co/images/teamsForEducation/input-output-tests/publish-unpublished.gif)
...
![Student Notification](https://replit-docs-images.util.repl.co/images/teamsForEducation/input-output-tests/student-notification.png)
...
![Image showing student running the test- fail](https://replit-docs-images.util.repl.co/images/teamsForEducation/input-output-tests/match-test-failing.png)

The student can check the results to see what the expected output should be.

![Image showing failed results match](https://replit-docs-images.util.repl.co/images/teamsForEducation/input-output-tests/match-test-fail-results.png)

Let's add some code to make the test pass. We'll change the code to print the full name and then run the test again.

![Image showing string-code](https://replit-docs-images.util.repl.co/images/teamsForEducation/input-output-tests/match-test-passed.png)
...
![Image showing the passed results](https://replit-docs-images.util.repl.co/images/teamsForEducation/input-output-tests/match-passed-results.png)
...
![Image showing the exact test config](https://replit-docs-images.util.repl.co/images/teamsForEducation/input-output-tests/exact-test-config.png)
...
![Image showing incorrect pi test fail](https://replit-docs-images.util.repl.co/images/teamsForEducation/input-output-tests/exact-failed-pi-results.png)
...
![Image showing exact test passing ](https://replit-docs-images.util.repl.co/images/teamsForEducation/input-output-tests/exact-test-pass.png)
...
![Image showing submit without running test](https://replit-docs-images.util.repl.co/images/teamsForEducation/input-output-tests/submit-without-testing.png)
...
![Image showing submission with failing tests](https://replit-docs-images.util.repl.co/images/teamsForEducation/input-output-tests/submit-with-failing-tests.png)
...
![Image showing regex test config](https://replit-docs-images.util.repl.co/images/teamsForEducation/input-output-tests/regex-test-config.png)
...
![Image showing regex passed results](https://replit-docs-images.util.repl.co/images/teamsForEducation/input-output-tests/regex-pass-results.png)
