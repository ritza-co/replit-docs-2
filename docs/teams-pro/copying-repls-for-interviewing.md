...
![template repl](https://replit-docs-images.util.repl.co/images/teamsPro/copying-repls-interviewing/template.png)
...
![fork repl](https://replit-docs-images.util.repl.co/images/teamsPro/copying-repls-interviewing/fork.png)

Choose the owner of the new forked repl, select your Team's name, and click "Confirm".

![confirm fork](https://replit-docs-images.util.repl.co/images/teamsPro/copying-repls-interviewing/create-fork.png)
...
![rename fork](https://replit-docs-images.util.repl.co/images/teamsPro/copying-repls-interviewing/rename-repl.png)
...
In the Team Dashboard, you'll find plus and list buttons on the right side of the screen, level with the 'Create Team Repl' button.
 ...
 ![collections](https://replit-docs-images.util.repl.co/images/teamsPro/copying-repls-interviewing/collections.png)

To name and create a new collection, click on the plus button.

 ![name collection](https://replit-docs-images.util.repl.co/images/teamsPro/copying-repls-interviewing/new-collection.png)

You can add interview repls to the collection by dragging them in. You can also arrange these in any order.

![add repls to collection](https://replit-docs-images.util.repl.co/images/teamsPro/copying-repls-interviewing/interview-collection.png)
...
![remove candidate](https://replit-docs-images.util.repl.co/images/teamsPro/copying-repls-interviewing/remove-candidates.png)
...
![adding notes](https://replit-docs-images.util.repl.co/images/teamsPro/copying-repls-interviewing/add-notes.png)
