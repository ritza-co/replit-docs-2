...
![**Image 1:** Creating our files project](https://replit-docs-images.util.repl.co/images/tutorials/02-managing-files/02-01-new-repl.png)
...
![**Image 2:** Adding data manually to our text file](https://replit-docs-images.util.repl.co/images/tutorials/02-managing-files/02-02-mydata-txt.png)
...
![**Image 3:** Reading data from a file and printing it out](https://replit-docs-images.util.repl.co/images/tutorials/02-managing-files/02-03-read-file.png)
...
![**Image 4:** Writing data to a file and viewing it](https://replit-docs-images.util.repl.co/images/tutorials/02-managing-files/02-04-write-file.png)
...
![**Image 5:** *Getting an API key from WeatherStack*](https://replit-docs-images.util.repl.co/images/tutorials/02-managing-files/02-05-weatherstack-api.png)
...
![**Image 6:** *Getting the current weather in JSON format*](https://replit-docs-images.util.repl.co/images/tutorials/02-managing-files/02-06-get-request.png)
...
![**Image 7:** *Seeing a human-readable summary of the data*](https://replit-docs-images.util.repl.co/images/tutorials/02-managing-files/02-07-foramat-output.png)
...
![**Image 8:** *Creating the cities.txt file*](https://replit-docs-images.util.repl.co/images/tutorials/02-managing-files/02-08-add-cities.png)
...
![**Image 9:** *The script creates one file for each city*](https://replit-docs-images.util.repl.co/images/tutorials/02-managing-files/02-09-all-cities.png)

If you open up one of the files, you'll see it contains the date and temperature that we fetched from WeatherStack.

![**Image 10:** *Example data recorded for London*](https://replit-docs-images.util.repl.co/images/tutorials/02-managing-files/02-10-write-datetime-weather.png)
...
![**Image 11:** *Adding new data to the end of each file*](https://replit-docs-images.util.repl.co/images/tutorials/02-managing-files/02-11-london-txt.png)
...
![**Image 12:** *Downloading all of our files from Replit*](https://replit-docs-images.util.repl.co/images/tutorials/02-managing-files/02-12-export-files.png)
...
![**Image 13:** *The created data files on our local file system*](https://replit-docs-images.util.repl.co/images/tutorials/02-managing-files/02-13-files-zip.png)
...
![**Image 14:** *Be careful about overwriting your precious data*](https://replit-docs-images.util.repl.co/images/tutorials/02-managing-files/02-14-upload-files.png)
