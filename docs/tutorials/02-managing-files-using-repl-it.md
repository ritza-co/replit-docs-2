...
![**Image 13:** *The created data files on our local file system*](https://replit-docs-images.bardia.repl.co/images/tutorials/02-managing-files/02-13-files-zip.png)
