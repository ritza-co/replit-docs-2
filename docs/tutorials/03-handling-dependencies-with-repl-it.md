...
![**Image 1:** *Trying to use a dependency without installing it*](https://replit-docs-images.util.repl.co/images/tutorials/03-handling-dependecies/03-01-error-no-module.png)
...
![**Image 2:** *Seamless external package use on a new repl*](https://replit-docs-images.util.repl.co/images/tutorials/03-handling-dependecies/03-02-import-module.png)
...
![**Image 3:** *Using the GUI package manager to find a package*](https://replit-docs-images.util.repl.co/images/tutorials/03-handling-dependecies/03-03-find-package.png)
...
![**Image 4:** *Installing a package from the overview page*](https://replit-docs-images.util.repl.co/images/tutorials/03-handling-dependecies/03-04-add-package.png)
...
![**Image 5:** *The `pyproject.toml` file lists all dependencies and their versions.*](https://replit-docs-images.util.repl.co/images/tutorials/03-handling-dependecies/03-05-project-files.png)
...
![**Image 6:** *We can access the `spaCy` package via the package index"*](https://replit-docs-images.util.repl.co/images/tutorials/03-handling-dependecies/03-06-installing-spacy.png)
...
![**Image 7:** *The `spaCy` documentation gives us information about the model*](https://replit-docs-images.util.repl.co/images/tutorials/03-handling-dependecies/03-07-spacy-docs.png)
...
![**Image 8:** *This is the `en_core_web_sm` GitHub page*](https://replit-docs-images.util.repl.co/images/tutorials/03-handling-dependecies/03-08-spacy-component.png)

The GitHub page also lets us know what version of `spaCy` is needed to make sure the model runs correctly. 

![**Image 9:** *The GitHub page provides information about the requirements and features of the model*](https://replit-docs-images.util.repl.co/images/tutorials/03-handling-dependecies/03-09-spacy-version.png)
...
![**Image 10:** *The model can be found under the "Assets" heading*](https://replit-docs-images.util.repl.co/images/tutorials/03-handling-dependecies/03-10-assets.png)
...
![**Image 11:** *Modifying `pyproject.toml` to explicitly point to the model allows our application to find it and use it*](https://replit-docs-images.util.repl.co/images/tutorials/03-handling-dependecies/03-11-pyproject-toml.png)
...
![**Image 12:** *`spaCy` and the necessary components are all found as dependencies, so the application runs successfully*](https://replit-docs-images.util.repl.co/images/tutorials/03-handling-dependecies/03-12-brown-fox.png)
...
![**Image 13:** *Using `spaCy` to extract people in today's news.*](https://replit-docs-images.util.repl.co/images/tutorials/03-handling-dependecies/03-13-using-spacy.png)
