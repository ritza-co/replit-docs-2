...
![**Image 2:** *Choosing PyGame from the `Create New Repl` screen.*](https://replit-docs-images.bardia.repl.co/images/tutorials/07-pygame/07-02-new-pygame-repl.png)
...
![**Image 3:** *Viewing our sprite after uploading it.*](https://replit-docs-images.bardia.repl.co/images/tutorials/07-pygame/07-03-upload-png-sprite.png)
...
![**Image 4:** *Drawing the tennis ball in our PyGame environment.*](https://replit-docs-images.bardia.repl.co/images/tutorials/07-pygame/07-04-insert-run-ball.png)
...
![**Image 5:** *The ball falling at a constant rate.*](https://replit-docs-images.bardia.repl.co/images/tutorials/07-pygame/07-05-GIF-falling-ball.gif)
...
![**Image 6:** *Now we can bounce the ball off the ceiling.*](https://replit-docs-images.bardia.repl.co/images/tutorials/07-pygame/07-06-GIF-bounce-off-roof.gif)
...
![**Image 7:** *Juggling three balls.*](https://replit-docs-images.bardia.repl.co/images/tutorials/07-pygame/07-07-GIF-three-balls.gif)
...
![**Image 8:** *Adding more balls.*](https://replit-docs-images.bardia.repl.co/images/tutorials/07-pygame/07-08-multiple-balls.png)
