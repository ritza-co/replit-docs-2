...
![**Image 1:** *Setting up our project structure for `pytest`.*](https://replit-docs-images.util.repl.co/images/tutorials/09-TDD/09-01-pytest-project-structure.png)
...
![**Image 2:** *Reading the `pytest` error messages.*](https://replit-docs-images.util.repl.co/images/tutorials/09-TDD/09-02-run-pytest.png)
...
![**Image 3:** *Seeing our tests pass after updating the code.*](https://replit-docs-images.util.repl.co/images/tutorials/09-TDD/09-03-pytest-green-output.png)
...
![**Image 4:** *Seeing more failures after adding more tests.*](https://replit-docs-images.util.repl.co/images/tutorials/09-TDD/09-04-run-tests.png)
...
![**Image 5:** *Progress: some of our tests pass now.*](https://replit-docs-images.util.repl.co/images/tutorials/09-TDD/09-05-three-green-dots.png)
...
![**Image 6:** *All of the tests pass after adding a new function.*](https://replit-docs-images.util.repl.co/images/tutorials/09-TDD/09-06-five-passed.png)
...
![**Image 7:** *Using our function in a basic console application.*](https://replit-docs-images.util.repl.co/images/tutorials/09-TDD/09-07-using-function.png)
...
![**Image 8:** *Triggering a new error and invoking `pytest` from the output pane.*](https://replit-docs-images.util.repl.co/images/tutorials/09-TDD/09-08-run-pytestmain.png)
