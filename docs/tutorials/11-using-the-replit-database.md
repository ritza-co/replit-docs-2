...
![**Image 5:** *The user menu: They can now choose what action to do.*](https://replit-docs-images.util.repl.co/images/tutorials/11-database/11-05-choose-add-contact.png)
