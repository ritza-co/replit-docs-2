...
![Bot functionality](https://replit-docs-images.util.repl.co/images/tutorials/18-telegram-bot/bot_functionality.gif)
...
It would be helpful if you are familiar with the [Replit database](/tutorials/using-the-replit-database), but it's not a necessity.
...
![BotFather search](https://replit-docs-images.util.repl.co/images/tutorials/18-telegram-bot/bot_father.png)

To activate the BotFather, click on "start".

![Activating BotFather](https://replit-docs-images.util.repl.co/images/tutorials/18-telegram-bot/bot_father_start.png)
...
![Generating bot token](https://replit-docs-images.util.repl.co/images/tutorials/18-telegram-bot/token.png)
...
![Creating a new Repl](https://replit-docs-images.util.repl.co/images/tutorials/18-telegram-bot/new_repl.png)
...
![Creating a new environment variables](https://replit-docs-images.util.repl.co/images/tutorials/18-telegram-bot/env_variables.png)
