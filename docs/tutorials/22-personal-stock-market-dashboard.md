...
![Dashboard functionality](https://replit-docs-images.util.repl.co/images/tutorials/22-stock-market/dashboard_functionality.png)
...
![Creating a Python repl](https://replit-docs-images.util.repl.co/images/tutorials/22-stock-market/create-python-repl.png)
...
![Initial dashboard](https://replit-docs-images.util.repl.co/images/tutorials/22-stock-market/initial-dashboard.png)
...
![Opn in new tab](https://replit-docs-images.util.repl.co/images/tutorials/22-stock-market/replit-browser-open-in-new-tab.png)
...
![In browser console](https://replit-docs-images.util.repl.co/images/tutorials/22-stock-market/json-portfolio-in-browser-console.png)
...
![Dashboard with portfolio](https://replit-docs-images.util.repl.co/images/tutorials/22-stock-market/dashboard-with-portfolio.png)
