...
![New repl](https://replit-docs-images.util.repl.co/images/tutorials/26-pdf-report-generator/new-repl.png)
...
![Spreadsheet data](https://replit-docs-images.util.repl.co/images/tutorials/26-pdf-report-generator/spreadsheet_data.gif)
...
![Sales dataframe](https://replit-docs-images.util.repl.co/images/tutorials/26-pdf-report-generator/sales_dataframe.png)
...
![Decimal places](https://replit-docs-images.util.repl.co/images/tutorials/26-pdf-report-generator/sale_revenuedp.png)
...
![Console dataframe output](https://replit-docs-images.util.repl.co/images/tutorials/26-pdf-report-generator/console_dataframe_output.png)
...
![Piechart plots](https://replit-docs-images.util.repl.co/images/tutorials/26-pdf-report-generator/piechart_plots.png)
...
![Replit browser open in new tab](https://replit-docs-images.util.repl.co/images/tutorials/26-pdf-report-generator/replit-browser-open-in-new-tab.png)

Then upload `sales-july-2021.xlsx` again, and wait for your report to generate. It should look something like this:

![Final report](https://replit-docs-images.util.repl.co/images/tutorials/26-pdf-report-generator/final_report.png)
...
* Some of our other tutorials delve into other aspects of Flask, such as this [stock market dashboard tutorial](/tutorials/personal-stock-market-dashboard). The web application interface we've built above is minimal and may benefit from additional functionality.
* We also have [another tutorial on Matplotlib](/tutorials/data-science-and-visualisation-with-repl-it). Additionally, Matplotlib provides [a number of tutorials on their website](https://matplotlib.org/stable/tutorials/index.html).
