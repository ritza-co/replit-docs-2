...
![Paid content site functionality](https://replit-docs-images.util.repl.co/images/tutorials/29-paid-content-site/site-functionality.gif)

## Getting started

To get started, create a Python repl.

![Create python repl](https://replit-docs-images.util.repl.co/images/tutorials/29-paid-content-site/create-python-repl.png)
...
![Random string](https://replit-docs-images.util.repl.co/images/tutorials/29-paid-content-site/randomstring.png)
...
![Repl secrets](https://replit-docs-images.util.repl.co/images/tutorials/29-paid-content-site/repl-secrets.png)
...
![Login button](https://replit-docs-images.util.repl.co/images/tutorials/29-paid-content-site/login-button.png)
...
![Create forms.py file](https://replit-docs-images.util.repl.co/images/tutorials/29-paid-content-site/forms-py-in-file-pane.png)
...
![Folder structure](https://replit-docs-images.util.repl.co/images/tutorials/29-paid-content-site/folder-structure.png)
...
![Open in new window](https://replit-docs-images.util.repl.co/images/tutorials/29-paid-content-site/open-new-window.png)

If you add free PDFs, you'll be able to download them, but you won't be able to purchase paywalled PDFs yet.

![Free pdf download](https://replit-docs-images.util.repl.co/images/tutorials/29-paid-content-site/free-pdf-download.png)
...
![Stripe Key](https://replit-docs-images.util.repl.co/images/tutorials/29-paid-content-site/stripe-key.png)
...
![Repl URL](https://replit-docs-images.util.repl.co/images/tutorials/29-paid-content-site/repl-url.png)
...
![Paywall](https://replit-docs-images.util.repl.co/images/tutorials/29-paid-content-site/alice-paywall.png)
![Checkout page](https://replit-docs-images.util.repl.co/images/tutorials/29-paid-content-site/checkout-page.png)
...
![PDF purchased](https://replit-docs-images.util.repl.co/images/tutorials/29-paid-content-site/alice-purchased.gif)
...
![Add webhook](https://replit-docs-images.util.repl.co/images/tutorials/29-paid-content-site/add-webhook.png)
...
2. Select the `checkout.session.completed` event from **Select events to listen to**.
    ...
    ![Webhook event](https://replit-docs-images.util.repl.co/images/tutorials/29-paid-content-site/webhook-event.png)
...
![Signing secret](https://replit-docs-images.util.repl.co/images/tutorials/29-paid-content-site/signing-secret.png)
...
![Stripe webhook success](https://replit-docs-images.util.repl.co/images/tutorials/29-paid-content-site/stripe-webhook-success.png)
