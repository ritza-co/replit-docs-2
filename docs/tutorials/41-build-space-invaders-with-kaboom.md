...
![Creating a new repl](https://replit-docs-images.util.repl.co/images/tutorials/41-space-invaders-kaboom/newrepl.png)
...
![alien grid](https://replit-docs-images.util.repl.co/images/tutorials/41-space-invaders-kaboom/alien-grid.png)
