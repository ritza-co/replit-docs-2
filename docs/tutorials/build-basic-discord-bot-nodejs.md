...
### Creating a bot in Discord and getting a token
 ...
 You can sign up for a free account over at [Discord](https://discordapp.com/register), and can download one of their desktop or mobile applications from [the Discord homepage](https://discordapp.com/). You can also use Discord in the browser.
